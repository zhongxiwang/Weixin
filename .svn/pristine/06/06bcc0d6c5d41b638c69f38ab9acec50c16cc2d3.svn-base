...
namespace WxUilt
{
    public class Cryptography
    {
        ...
        public static string SHA1_Encoding(string str)
        {
            ...
            var n = Convert.ToBase64String(str2);
            return Encoding.ASCII.GetString(str2);
        }
        ///// <summary>
        ///// 检验signature
        ///// </summary>
        ...
        //{
        //    string strResult = FormsAuthentication.HashPasswordForStoringInConfigFile(token + timestamp, "SHA1");
